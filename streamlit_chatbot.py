...
def replace_date_keywords(text: str) -> str:
    """
    Ersetzt deutsche relative Datumsausdrücke (heute, morgen, übermorgen, nächsten <Wochentag>) 
        ...
        if st.session_state.stage == "chat":
            ...
            if match:
                try:
                    ...
                    pass  # Ungültiges JSON: weiter chatten
...
#  >>> STAGE: done <<<
# ===============================================================
# In Stage "done" wird die Eingabe wie oben behandelt:
# Bot-Antwort bei user_input wird direkt angehängt, ohne explizites Rerun.

# ===============================================================
#  >>> CHAT-HISTORIE AM ENDE NOCHMALS (optional) <<<
# ===============================================================
# (Wurde bereits oben gerendert.)
